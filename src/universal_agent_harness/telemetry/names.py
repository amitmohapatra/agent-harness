...
MEMORY_RECALL: Final = "agent.memory.recall"
MEMORY_OBSERVE: Final = "agent.memory.observe"
MEMORY_REMEMBER: Final = "agent.memory.remember"
MEMORY_FORGET: Final = "agent.memory.forget"
MEMORY_LIST: Final = "agent.memory.list"
MEMORY_HISTORY: Final = "agent.memory.history"
MEMORY_GRAPH: Final = "agent.memory.graph"
MEMORY_INGEST: Final = "agent.memory.ingest"
MEMORY_VERIFY: Final = "agent.memory.verify"
...
MEMORY_TYPE: Final = "memory.type"
MEMORY_LIFETIME: Final = "memory.lifetime"
MEMORY_VISIBILITY: Final = "memory.visibility"
MEMORY_ID: Final = "memory.id"
MEMORY_RESULT_COUNT: Final = "memory.result_count"
MEMORY_HOPS: Final = "memory.graph.hops"
